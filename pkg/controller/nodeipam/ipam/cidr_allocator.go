...
func New(kubeClient clientset.Interface, cloud cloudprovider.Interface, networkClient networkclientset.Interface, nodeInformer informers.NodeInformer, allocatorType CIDRAllocatorType, allocatorParams CIDRAllocatorParams) (CIDRAllocator, error) {
	...
	case CloudAllocatorType:
		return NewCloudCIDRAllocator(kubeClient, cloud, networkClient, nodeInformer)
	default:
